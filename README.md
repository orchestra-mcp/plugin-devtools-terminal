# Orchestra Plugin: devtools-terminal
...
```bash
go install github.com/orchestra-mcp/plugin-devtools-terminal/cmd@latest
```
...
```yaml
- id: tools.devtools-terminal
  binary: ./bin/devtools-terminal
  enabled: true
```
